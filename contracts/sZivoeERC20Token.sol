...
contract sZivoeERC20Token is ERC20Permit, DaoOwnable {
    ...
    constructor() ERC20("Staked ZivoE", "sZVE", 9) ERC20Permit() {
    ...
    /**
        @notice increases sZVE supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sZVE
